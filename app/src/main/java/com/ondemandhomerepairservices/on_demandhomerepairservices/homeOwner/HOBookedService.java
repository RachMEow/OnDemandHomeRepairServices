...
public class HOBookedService extends SPProvidedService {
    ...
    public HOBookedService(String hoBookedService_id, String spProvidedService_id, String spId, String spCompanyName, String service_id, String serviceName, double hoursRate){
        super(spProvidedService_id, spId, spCompanyName, service_id, serviceName, hoursRate);
