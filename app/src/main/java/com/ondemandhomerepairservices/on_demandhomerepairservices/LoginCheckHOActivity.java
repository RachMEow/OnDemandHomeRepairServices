...
public class LoginCheckHOActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseHOs = database.getReference("message");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login_check_ho);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseHOs.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot postSnapShot : dataSnapshot.getChildren()) {
                            //getting accounts
                            HomeOwner homeOwner = postSnapShot.getValue(HomeOwner.class);
                        ...
                        if (validate()) {
                            for (HomeOwner homeOwner : homeOwners) {
                                if (usernameInput.equals(homeOwner.get_username()) && passwordInput.equals(homeOwner.get_password())) {
